...
const addCretedUser = async(req,res)=>{
    try{
        ...
        if(userData){
            res.render('home',{message:"Your registration has been successfull"});
            res.redirect('/admin/home');
        }
        else{
            res.render('home',{message:"Your registration has been failed"})
        }
